...
export const buySubscription = asyncHandler(async (req, res, next) => {
  ...
  if (!user) {
    throw new ApiError("Unauthorized, please login");
  }

  // Checking the user role
  if (user.role === "ADMIN") {
    throw new ApiError(400, "Admin cannot purchase a subscription");
  }
...
export const cancelSubscription = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    throw new ApiError(error.error.description, error.statusCode);
  }
